...
Важно: първоначалната документация споменаваше работа с отделни GitHub branch-ове и pull requests, но това не личеше от наличния ZIP/репозиториум. Затова документацията е коригирана така, че да описва реално видимото разпределение по файлове и задачи, без да твърди, че всеки е работил в отделен branch.
...
## 4. Корекция спрямо забележките

В старата версия на документацията имаше текст: „Всеки член на екипа работеше в собствен branch“. Това е премахнато, защото в предоставения проект не се виждат реални branch-ове, pull requests или ясна GitHub история с отделни приноси.
